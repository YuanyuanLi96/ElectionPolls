...
polls_2016=filter_poll(add_date_2016)
...
write.csv(polls_2016,file="data/polls_2016.csv",row.names = F)

polls_2020=filter_poll(add_date_2020)
...
write.csv(polls_2020,file="data/polls_2020.csv",row.names = F)
...
dim(raw_polls)
nlevels(raw_polls$pollster)#168 pollsters
...
write.table(long_dat, file ="data/long_dat.csv", sep=",",
